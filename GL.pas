...
{   Contact axeman@mail.dma.be or visit bewoner.dma.be/axeman                  }
{   To use an OpenGL DLL other than Microsoft's, edit the file 'GLDRIVER.INC'  }
{   that came with these units. In this file, define either 'SGIGL' to use     }
{   Silicon Graphics' OpenGL, or '3DFXGL' to use 3dfx's driver. The GLU and    }
{   GLUT units automatically use the same file to adapt to the situation, but  }
{   be aware that 3dfx does not have a GLU or GLUT library, and I don't know   }
{   if 3dfx OpenGL can work with the GLU and GLUT for Microsoft OpenGL.        }
{   The constants OPENGLDLL, GLUDLL and GLUTDLL indicate which DLLs are        }
{   actually being used by your program.                                       }
{   If you know of any other OpenGL implementations you think should be        }
{   supported by this unit, don't hesitate to let me know.                     }
{******************************************************************************}
